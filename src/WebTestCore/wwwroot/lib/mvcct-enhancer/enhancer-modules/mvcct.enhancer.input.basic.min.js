(function(){(function(T){var m=this||(0,eval)("this");(function(d){if("function"===typeof define&&define.amd)define(["../mvcct.enhancer"],d);else if("object"===typeof exports&&"object"===typeof module)module.exports=d(require("mvcct-enhancer"));else{var g=m.mvcct=m.mvcct||{};d(g.enhancer,m.globalize)}})(function(d){function g(b){b=b.split("-W");b=new Date(Date.UTC(parseInt(b[0]),0,1+7*(parseInt(b[1])-1)));4>=b.getDay()?b.setDate(b.getDate()-b.getDay()+1):b.setDate(b.getDate()+8-b.getDay());return b}
function n(b){b=new Date(+b);b.setHours(0,0,0);b.setMilliseconds(0);b.setDate(b.getDate()+4-(b.getDay()||7));var a=Math.ceil(((b-new Date(b.getFullYear(),0,1))/864E5+1)/7),a=a+"";2>a.length&&(a="0"+a);for(b=b.getFullYear()+"";4>b.length;)b="0"+b;return b+"-W"+a}function u(b,a){function H(h){"text"==h.getAttribute("type")&&h.addEventListener("keypress",function(b){b=b||m.event;var c;var a=null==b.which?b.keyCode:0!=b.which&&0!=b.charCode?b.which:null;c=v.decimal;var f=v.plusSign,e=v.minusSign,d,g=
h.getAttribute("data-val-correcttype-type")||"3";d=parseInt(g);g=3==d;d=1!=d;var k=h.getAttribute("min");k||(k=h.getAttribute("data-val-range-min"));k&&0<=parseFloat(k)&&(d=!1);0==a||13==a||9==a||8==a||48<=a&&57>=a?c=!0:!d||a!=f.charCodeAt(0)&&a!=e.charCodeAt(0)?g&&a==c.charCodeAt(0)?(a=h.value,c=0>a.indexOf(c)):c=!1:(a=h.value,c=0>a.indexOf(f)&&0>a.indexOf(e));c||b.preventDefault()})}if(!I){d.Globalize=function(){return a};var c=b.editFormats||{},f;for(f in J)e[f]=c[f]===T?J[f]:c[f];var c=a.locale().attributes.language,
v=a.cldr.get("main/"+c).numbers["symbols-numberSystem-latn"];K=a.dateParser({raw:"HH:mm:ss"});L=a.dateParser({raw:"HH:mm"});p=function(a){return K(a)||L(a)};M=a.dateParser({raw:"yyyy-MM-ddTHH:mm:ss"});N=a.dateParser({raw:"yyyy-MM-ddTHH:mm"});q=function(a){return M(a)||N(a)};r=a.dateParser({raw:"yyyy-MM-dd"});t=a.dateParser({raw:"yyyy-MM"});w=a.dateFormatter({raw:"HH:mm:ss"});x=a.dateFormatter({raw:"yyyy-MM-ddTHH:mm:ss"});y=a.dateFormatter({raw:"yyyy-MM-dd"});z=a.dateFormatter({raw:"yyyy-MM"});A=a.numberParser();
var k=a.dateParser(e.timeFormat),n=a.dateParser(e.timeFormat1);O=function(a){return k(a)||n(a)};var u=a.dateParser(e.datetimeFormat),G=a.dateParser(e.datetimeFormat1);P=function(a){return u(a)||G(a)};Q=a.dateParser(e.dateFormat);R=a.dateParser(e.weekFormat);S=a.dateParser(e.monthFormat);l=a.numberFormatter();B=a.dateFormatter(e.timeFormat);C=a.dateFormatter(e.datetimeFormat1);D=a.dateFormatter(e.dateFormat);E=a.dateFormatter(e.weekFormat);F=a.dateFormatter(e.monthFormat);b.browserSupport||(b.browserSupport=
