...
namespace MvcControlsToolkit.Core.TagHelpers
{
    public interface ITagHelpersProvider
    {
        ...
        IHtmlContent RenderButton(StandardButtons buttonType, string arguments, string cssClass, ContextualizedHelpers helpers, IStringLocalizer localizer, bool visibleText=false, bool isSubmit=false, string controlType=null);
    }
}
